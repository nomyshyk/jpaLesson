...
public class CriteriaTest {
    ...
    public static void multipleSelectJPQL(){
        ...
        Query query =
                session.createQuery("select name, country.name, age " +
                        "from Employee");
    ...
    public static void criteria1(){
        ...
        for (Employee employee : employeeList){
            System.out.println(employee.getName() + " " + employee.getCountry().getName()
                    + " " + employee.getAge() + " " + employee.getDepartment().getName());
        }
        session.close();
        HibernateUtil.shutdown();
    }
    ...
    public static void criteriaJoin(){
        ...
        Join<Employee, Departments> dept = rootEmployee.join("department");
